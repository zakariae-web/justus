        ...
        <div class="intro-body">
            <div class="row register-form">
                <div class="col-md-8 offset-md-2" style="margin-top: 50px;">
                    <form class="custom-form" action="{{route('s3.update', ['s3' => $s3->id])}}" method="POST" enctype="multipart/form-data">
                    @CSRF
                    @method('PUT')
                        <h1>Update Form</h1>
                        <div class="row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">full name </label></div>
                            <div class="col-sm-6 input-column"><input type="text" name="lastname" id="lastname" class="input" value="{{old('lastname',$s3->lastname)}}" placeholder="Full name"   required=""></div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="email-input-field">twitter </label></div>
                            <div class="col-sm-6 input-column"><input type="text" name="twitter" id="twitter" class="input" value="{{old('twitter',$s3->twitter)}}" placeholder="your twitter link : "   required=""  pattern="https?://www.+" title="Include https://www.example.com"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="pawssword-input-field">github </label></div>
                            <div class="col-sm-6 input-column"><input type="text" name="github" id="github" class="input" value="{{old('github',$s3->github)}}" placeholder="your github link : "   required=""  pattern="https?://www.+" title="Include https://www.example.com"></div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-6 input-column"><input type="text" name="about" id="about" class="input" value="{{old('about',$s3->about)}}" placeholder="... "   required=""></div>
                        </div>
