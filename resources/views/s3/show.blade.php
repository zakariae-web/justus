...
<head>
    ...
    <link rel="stylesheet" href="/show/assets/bootstrap/css/bootstrap.min.css">
    ...
    <link rel="stylesheet" href="/show/assets/css/-Login-form-Page-BS4--Login-form-Page-BS4.css">
    <link rel="stylesheet" href="/show/assets/css/Features-Cards-icons.css">
    <link rel="stylesheet" href="/show/assets/css/Pretty-Registration-Form-.css">
    <link rel="stylesheet" href="/show/assets/css/Profile-Card.css">
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="77">
    ...
    <header class="masthead" style="background-image:url('/assets/img/background.jpg');">
        <div class="profile-card">
            <div class="profile-back"></div><img class="rounded-circle profile-pic" src="/images/cv2/{{$s3['image']}}">
            <h3 class="profile-name">{{$s3['lastname']}}</h3>
            <p class="profile-bio">{{$s3['about']}}</p>
            <a href="{{$s3['twitter']}}" target="_blanc">
            ...
            <a href="{{$s3['github']}}" target="_blanc">
                <svg height="50" width="50" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1024 1024" class="icon">
            ...
            <a href="{{$s3['linkcv']}}" target="_blanc"><i class="fa-regular fa-address-card fa-2xl" style="color:white;"></i></a>
        </div>
    </header>
    ...
    <script src="/show/assets/bootstrap/js/bootstrap.min.js"></script>
    <script src="/show/assets/js/grayscale.js"></script>
